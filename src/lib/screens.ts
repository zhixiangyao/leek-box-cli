export type Screen = 'stock-list' | 'add-stock' | 'remove-stock'
...
export const SCREEN_LIST = ['stock-list', 'add-stock', 'remove-stock'] as const satisfies readonly Screen[]

export const isScreen = (str: string | undefined): str is Screen =>
  str !== undefined && SCREEN_LIST.includes(str as Screen)

export const toScreen = (str: string | undefined): Screen => (isScreen(str) ? str : 'stock-list')
